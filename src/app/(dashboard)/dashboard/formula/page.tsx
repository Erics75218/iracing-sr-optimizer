      ...
      <p className="text-muted-foreground">
        {seriesNotFound
          ...
          : selectedSeries
            ...
            : "Select a Formula series for this week's track and schedule, or browse SR-friendly recommendations below."}
      </p>
      ...
      <section className="rounded-lg border p-4 bg-card">
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          {seriesFilter
            ...
            : "Formula races this season, ranked by length and lap count."}
        </p>
        <div className="mt-3">
